...
//
// These helpers define the first bring-up format for packed W4 weights:
...
//
// This is intentionally host-side. It lets us verify the AWQ layout and CPU
// reference path before changing the AIE microkernel to consume packed W4.
